                    ...
                    <div class="panel-group category-products" id="accordian"><!--category-productsr-->
                        ...
                        <div class="panel panel-default">
                            <div class="panel-heading">
                                <h4 class="panel-title"><a href="{{ asset('shop?id='.$item->id)}}" style="color:green" onmouseover="this.style.color='orange';" onmouseout="this.style.color='green';">{{$item->CatagoryName}}>{{$item->CatagoryName}}</a></h4>
                            </div>
                        </div>           
                        @endforeach
