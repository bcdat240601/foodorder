...
<div class="container" style="margin-left: 100px">
    ...
    <form action="{{ route('food.edit') }}"  enctype="multipart/form-data" method="POST">
        @csrf
        <input type="text" name="id" value="{{$data->id}}" hidden>
        <br><p style="color: green">Product Name:</p><input type="text" name="FoodName" value="{{$data->FoodName}}"><br>
        <p style="color: green">Price:</p><input type="number" name="Price" value="{{$data->Price}}"> <br>
        <p style="color: green">Description:</p><textarea name="Description" id="" cols="80" rows="10" value="{{$data->Description}}"></textarea> 
